  ...
  return (
    ...
    <div className='h-[35rem] flex flex-row mt-28 absolute ml-36 rounded-xl w-[80rem] bg-white shadow-2xl shadow-black'>
        <div className='absolute px-28 h-[35rem] py-20 w-[40rem] bg-white ml-[40rem] rounded-r-xl'>
            <h1 className='font-great-vibes mb-2 text-7xl'>Solace Watch</h1>
            ...
            <button onClick={() => navigate("/CartPage")} className='w-full h-12 rounded-lg font-work-sans bg-black text-white transition-all duration-300 ease-in-out hover:bg-white'>BUY NOW</button>
        </div>
